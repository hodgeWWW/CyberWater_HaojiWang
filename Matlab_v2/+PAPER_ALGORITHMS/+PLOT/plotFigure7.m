...
Ke = 4;
[ ~, groups, Jmine ] = Kmean.calcKmeansBest( elevation, Ke, 1000, 1e-10, Q ); %改：[ ~, groups, Jmine ] = Kmean.calcKmeansBest( elevation, Ke, 1000, 1e-6, Q );
fname = 'OH_dem.png';
...
slope = features(:,6);
Ks = 4;
[ ~, groups, Jmins ] = Kmean.calcKmeansBest( slope, Ks, 1000, 1e-10, Q );%改：[ ~, groups, Jmins ] = Kmean.calcKmeansBest( slope, Ks, 1000, 1e-6, Q );
fname = 'OH_Slope.png';
filename = [folder fname];
